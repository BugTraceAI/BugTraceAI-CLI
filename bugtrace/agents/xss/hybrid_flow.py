...
from bugtrace.agents.xss.hybrid_phases import XSSHybridPhasesMixin
from bugtrace.agents.xss.hybrid_visual import XSSHybridVisualMixin

class XSSHybridFlowMixin(XSSHybridPhasesMixin, XSSHybridVisualMixin):

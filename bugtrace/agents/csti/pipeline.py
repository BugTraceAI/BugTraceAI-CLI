...
async def escalation_smart_probe(
    ...
    """
    # Marker must NOT contain "49": the eval check looks for "49" in the response,
    # so a literal "49" in the marker self-triggers a false positive on reflection.
    probe = "BT_CSTI_PROBE{{7*7}}${7*7}"
    ...
    try:
        ...
        if success and mutation:
            ...
            try:
                ...
                # "49" in the error page must not confirm. 5xx left flowing for error-signature SSTI.

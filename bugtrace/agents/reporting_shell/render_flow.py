...
from bugtrace.agents.reporting_shell.render_json import ReportingRenderJsonMixin
from bugtrace.agents.reporting_shell.render_md import ReportingRenderMdMixin
from bugtrace.agents.reporting_shell.render_engagement import ReportingRenderEngagementMixin
from bugtrace.agents.reporting_shell.render_html import ReportingRenderHtmlMixin

class ReportingRenderMixin(ReportingRenderJsonMixin, ReportingRenderMdMixin, ReportingRenderEngagementMixin, ReportingRenderHtmlMixin):
    pass

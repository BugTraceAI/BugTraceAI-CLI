...
from bugtrace.agents.reporting_shell.findings_b_core import ReportingFindingsBCoreMixin
from bugtrace.agents.reporting_shell.findings_b_extra import ReportingFindingsBExtraMixin

class ReportingFindingsBMixin(ReportingFindingsBCoreMixin, ReportingFindingsBExtraMixin):
    pass

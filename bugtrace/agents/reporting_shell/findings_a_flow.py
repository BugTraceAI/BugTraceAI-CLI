...
from bugtrace.agents.reporting_shell.findings_a_core import ReportingFindingsACoreMixin
from bugtrace.agents.reporting_shell.findings_a_extra import ReportingFindingsAExtraMixin

class ReportingFindingsAMixin(ReportingFindingsACoreMixin, ReportingFindingsAExtraMixin):
    pass

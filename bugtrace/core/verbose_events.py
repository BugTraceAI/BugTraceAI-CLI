...
_TEMPLATES: Dict[str, Tuple[str, str]] = {
    ...
    'recon.auth.started':          ('INFO',    '[RECON] Auth discovery scanning {urls_count} URLs'),
    'recon.auth.scanning_url':     ('INFO',    '[RECON] Auth scan {index}/{total}: {url}'),
    'recon.auth.completed':        ('INFO',    '[RECON] Auth discovery complete — {jwts_found} JWTs, {cookies_found} cookies'),
    # Discovery

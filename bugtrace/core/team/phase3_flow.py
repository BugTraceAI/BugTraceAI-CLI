...
from bugtrace.core.team.phase3_strategy import run_phase_3_strategy
from bugtrace.core.team.phase3_review import run_phase_3_global_review


class TeamPhase3Mixin:
    """Phase 3 strategy / global review."""

    async def _phase_3_strategy(self, dashboard, analysis_json_dir: Path) -> int:
        return await run_phase_3_strategy(self, dashboard, analysis_json_dir)

    async def _phase_3_global_review(self, dashboard, scan_dir):
        return await run_phase_3_global_review(self, dashboard, scan_dir)
